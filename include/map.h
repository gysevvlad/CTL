...
/* ____________________________________________________________________________
	Добавить iterator в map.
*/\
void map_add_iter_##key_t##_##data_t( \
	map_##key_t##_##data_t *map, \
	iterator_pair_##key_t##_##data_t *iter) { \
	linked_list_pair_##key_t##_##data_t *m =\
		(linked_list_pair_##key_t##_##data_t*)map;\
	linked_list_iter_push_back_pair_##key_t##_##data_t(\
	&m[ hash_##key_t( &iter-> data.key ) % HASHMAP_SIZE ],\
	iter);\
}\
